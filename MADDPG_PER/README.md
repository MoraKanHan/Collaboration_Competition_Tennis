...
# MADDPG_PER: Multi-agent DDPG with priority experience replay
<h3>Introduction</h3>
For this project, MADDPG with priority experience replay were developed to train and evaluate two agents control rackets to bounce a ball over a net in the unity ML-agent Tennis environment.  This project is part of the Deep Reinforcement Learning Nanodegree program.
