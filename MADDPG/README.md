...
<h3>Introduction</h3>
For this project, MADDPG were developed to train and evaluate two agents control rackets to bounce a ball over a net in the unity ML-agent Tennis environment.  This project is part of the Deep Reinforcement Learning Nanodegree program.
...
### 4- Run Code
Follow the instructions in <code>MADDPG/Tennis.ipynb</code> Notebook to get started with training the agents agent!
